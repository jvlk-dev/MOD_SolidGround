...
public class SolidGroundConfigCommon {
    ...
    static {
        ...
        Y_LEVEL_SURFACE = BUILDER.defineInRange("Y_Level_Surface", 66, -64, 320);
        HARDNESS_AT_SURFACE = BUILDER.defineInRange("Hardness_At_Surface", 0.5, 0.0, 100.0);

        Y_LEVEL_DEEPSLATE_START = BUILDER.defineInRange("Y_Level_Deepslate_Start", 8, -64, 320);
        HARDNESS_AT_DEEPSLATE_START = BUILDER.defineInRange("Hardness_At_Deepslate_Start", 1.0, 0.0, 100.0);

        Y_LEVEL_BEDROCK = BUILDER.defineInRange("Y_Level_Bedrock", -64, -64, 320);
